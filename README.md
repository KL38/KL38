...
| :------------------------- | :------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| 🧠 **LLM & RAG**           | **NBA Analyst AI**               | Evaluation of a RAG system — **faithfulness ×2.5, context precision ×4.3**, measured on 60 domain questions                                           |                                                                                   [Repo](https://github.com/KL38/OC_P10_RAG_NBA-comments-and-stats) · [Eval report](https://kl38.github.io/OC_P10_RAG_NBA-comments-and-stats/)                                                                                  |
