...
| :------------------------- | :------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| 🧠 **LLM & RAG**           | **NBA Analyst AI**               | Agentic RAG on NBA data: FAISS retrieval, agent routing text vs SQL, and RAGAS evaluation harness: **faithfulness ×2.5** measured on 60 domain questions|                                                                                   [Repo](https://github.com/KL38/OC_P10_RAG_NBA-comments-and-stats) · [Eval report](https://kl38.github.io/OC_P10_RAG_NBA-comments-and-stats/)                                                                                  |
